    ...
    ((r._init = function () {
      ...
      if (n.startAt) {
        ...
        if (this._startAt)
          ...
          return (
            (i.overwrite = 0),
            void (this._startAt = M.to(this.target, 0, i))
          );
        }
      if (
        ((this._ease = h
      ...
      ((u.prototype = {
        ...
        unload: function () {
          for (
            ...
            (e.stop(i[r].id),
              e._webAudio ? i[r].disconnect(0) : (i[r].src = ""));
          ...
          function (t, e) {
            ...
            ((i.prototype = Object.create(r.prototype)),
              ...
              (i.prototype.drawRoundedRect = function (t, e, i, r, n) {
                return (
                  this.drawShape(new l.RoundedRectangle(t, e, i, r, n)),
                  this
                );
              }),
            ...
            ((i.prototype = Object.create(r.prototype)),
              ...
              (i.prototype.render = function (t) {
                ...
                if (0 !== i) {
                  ...
                  (o.prepend(
                    this.renderer.currentRenderTarget.projectionMatrix,
                  ),
                    n.uniformMatrix3fv(
            ...
            ((i.prototype = Object.create(r.prototype)),
              ...
              (i.prototype.applyFilter = function (t, e, i) {
                ...
                (r.calculateMappedMatrix(
                  ...
                  (this.uniforms.otherMatrix.value =
                    this.maskMatrix.toArray(!0)));
                var n = this.getShader(t);
                r.applyFilter(n, e, i);
              }),
              Object.defineProperties(i.prototype, {
          ...
          function (t, e) {
            ...
            ((i.Triangulate = function (t) {
              ...
              for (var a = r; a > 3; ) {
                ...
                if (g)
                  (n.push(h, l, u), o.splice((s + 1) % a, 1), a--, (s = 0));
                else if (s++ > 3 * a) {
                  if (!e) return null;
                  ...
                  function (t, e) {
                    ...
                    for (
                      ...
                      (i[r] === e || i[r]._originalHandler === e) &&
                        i.splice(r, 1);
                    return (
                      0 === i.length && (this._listeners[t] = null),
                      this
                    );
                  }),
      ...
      ((r.prototype.wait = function (t, e) {
        ...
        (r.prototype.update = function () {
          for (var t = this.waits.length - 1; t >= 0; t--) {
            var e = this.waits[t];
            (e.count--,
              e.count <= 0 && (e.callback(), this.waits.splice(t, 1)));
          }
